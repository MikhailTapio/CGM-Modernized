...
public class ControllerEvents {
            ...
            if (heldItem.getItem() instanceof ItemGun && MrCrayfishGunMod.proxy.isZooming()) {
                ...
                if (scope != null) {
                    ...
                    switch (scopeType) {
                        case LONG:
                        case MEDIUM:
                            final boolean isSteadyAiming = event.getController().isButtonPressed(Buttons.RIGHT_THUMB_STICK);
    ...
    public void onRender(TickEvent.RenderTickEvent event) {
        ...
        if (mc.currentScreen == null && reloadCounter != -1 && controller.isButtonPressed(Buttons.X)) reloadCounter++;
